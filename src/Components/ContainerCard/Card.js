    ...
    return (
        <div className="border shadow-lg rounded mx-5">
            ...
            <div className="px-2 flex flex-col items-center">
                ...
                <div>
                <button onClick={()=> add(items)} className="w-60 bg-cyan-800 hover:bg-teal-700 hover:text-black transition ease-in duration-300 py-3 my-4 rounded-lg text-white font-medium text-lg">Add to list</button>
                </div>
            </div>
        </div>
    );
